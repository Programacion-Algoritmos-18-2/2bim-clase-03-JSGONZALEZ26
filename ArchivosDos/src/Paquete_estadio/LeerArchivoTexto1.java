...
public class LeerArchivoTexto1 {
    ...
    public void abrirArchivo() {
        try {
            entrada = new Scanner(new File("datos_estadios.txt"));
        } // fin de try
    ...
    public ArrayList<Estadio> leerRegistros() {
        ...
        OperacionData mt = new OperacionData();
        try // lee registros del archivo, usando el objeto Scanner
        {
            ...
            while (entrada.hasNext()) {
                ...
                e.setTipodeDeporte(linea_partes.get(1));
                e.setCapacidad(Integer.parseInt(linea_partes.get(2)));
                lista.add(e);
            } // fin de while
        } // fin de try
